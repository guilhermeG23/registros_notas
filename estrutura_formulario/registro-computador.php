...
<tr>
	...
	<td><input type="text" class="form-control" onkeyup="limitarInput(this,100)" value="" id="modelo" name="modelo" maxlength="100" placeholder="EX: Modelo" autocomplete="off"></td>
</tr>
<tr>
	<td><label class="col-form-label">Serial:</label></td>
	<td><input type="number" class="form-control" onkeyup="limitarInput(this, 44)" value="" id="sn" name="sn" maxlenght="44" placeholder="EX: 000000000" autocomplete="off"></td>
</tr>

<tr>
	...
	<td colspan="6"><input type="text" class="form-control" onkeyup="limitarinput(this, 30)" value="" id="seriaW" name="seriaW" maxlength="30" placeholder="xxxxx-xxxxx-xxxxx-xxxxx-xxxxx" autocomplete="off"></td>
</tr>
<tr>

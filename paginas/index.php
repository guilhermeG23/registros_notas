...
include ('../comandos_sql/sql.php');
include ('../chamadas/cabecalho.php');
include ('../chamadas/menu.php');
include ('../chamadas/registro-equipamento-modal.php');
include ('../chamadas/registro-windows-modal.php');
include ('../chamadas/registro-office-modal.php');
include ('../chamadas/windows-registro.php');
include ('../chamadas/office-registro.php');

				...
				<form action="cadastrar.php" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						<table class="table table-borderless tabela-registro">
							<hr>
							<tr>
								<td class="ajuste-padding-externo"><button type="button" class="btn btn-link btn-sem-padding" onclick="descer_menu('Computador');"><label id="texto-mostrar-mais-Computador">Computador</label></button></td>
					...
					<div id="Computador" class="esconder">
						<div class="form-group">
							<hr>
							<table class="table table-borderless tabela-registro">
								<tr>
									<td><label class="col-form-label">Computador</label></td>
								</tr>
							</table>
							<hr>
							<table class="table table-borderless tabela-registro">

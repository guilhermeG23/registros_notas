...
if (isset($_POST['pesquisar']) && strlen($_POST['pesquisar']) > 0) {
	...
	$query = "select * from vw_tabela_produtos where nota like '%{$variavel}%' or CNPJ like '%{$variavel}%' or Empresa like '%{$variavel}%' or Chave like '%{$variavel}%' order by ID_Produto desc;";
